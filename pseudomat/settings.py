"""
Django settings for pseudomat project.
...
SECRET_KEY = '&fu+-q-9$=u@tt=*wd^8k(v&v324%)l+h+zh_5)oyx*=cys!42'
...
WSGI_APPLICATION = 'pseudomat.wsgi.application'
